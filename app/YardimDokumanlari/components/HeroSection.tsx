...
// Dosya ikonunu Tabler Icons'tan import ediyoruz
...
export default function HeroSection({
  ...
  title = 'ÖN BAŞVURU ve ADAY FİRMA BAŞVURU SÜREÇ ADIMLARI',
}: HeroSectionProps) {
  return (
 ...
 <div
      ...
      <Container size="lg" style={{ position: "relative", zIndex: 1 }}>
        {/* Girişimcilik temasını yansıtan dosya ikonu */}
        <ThemeIcon
          variant="light"
          size={80}
          radius="xl"
          ...
          mt={60}
        >
          <IconFileText style={{ width: 48, height: 48 }} />
        </ThemeIcon>
        {/* Ana başlık */}
        <Title
          order={1}
