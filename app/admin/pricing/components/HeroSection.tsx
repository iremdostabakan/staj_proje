...
interface HeroSectionProps {
  height?: number; // opsiyonel props
}

export function HeroSection({ height = 300 }: HeroSectionProps) {
  return (
    <Box
      style={(theme) => ({
...
"&::after": {
  ...
  animation: `${gradientAnimation} 35s ease infinite`,
    ...
    >
      <Container size="lg" style={{ position: "relative", zIndex: 1, paddingTop: 40, height: "auto", minHeight:20 }}>
